...
class Tree{
	public $arr 	= [];
	public $icon = ['<span class="icon icon1">│　</span>','<span class="icon icon2">├　</span>','<span class="icon icon3">└　</span>'];
	public $nbsp = "&nbsp;";
	public $ret = '';
	public $level = 0;
	...
	function get_nav($bid,$maxlevel,$effected_id='navlist',$style='filetree ' ,$homefont='',$recursion=FALSE ,$child='',$enhomefont='',$lang='') {
		...
		if($homefont) $homefont='<li id="nav_0"><span class="fl_ico"></span><a href="'.URL().'" title="'.L('首页').'"><span class="fl">'.L('首页').'</span>'.$indexen.'</a></li>';
